...
def start():
    initialize_firebase_app(r'C:\Users\shubh\Desktop\Final_Year_Project\keys\SBI.json','https://sbi-server-default-rtdb.firebaseio.com/', "SBI_Server")
    initialize_firebase_app(r'C:\Users\shubh\Desktop\Final_Year_Project\keys\AXIS.json','https://axis-server-default-rtdb.firebaseio.com/', "AXIS_Server")
    initialize_firebase_app(r'C:\Users\shubh\Desktop\Final_Year_Project\keys\HDFC.json','https://hdfc-server-25e02-default-rtdb.firebaseio.com/', "HDFC_Server")
    while True:
